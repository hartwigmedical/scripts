...
VariantAnnotation::fixed(full_vcf)$ALT = CharacterList(lapply(fread(file=input_vcf, sep="\t", sep2=NULL, header=FALSE, stringsAsFactors=FALSE, select=5, skip=120)$V5, function(x) x))
