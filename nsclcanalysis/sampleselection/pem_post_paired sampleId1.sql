...
left join 
(select sampleId1, pretreatmentLine1, pretreatmentLine1PdDate, pretreatmentLine1StopReason from nsclcPairedSample where preTreatmentLine1 like '%peme%' or preTreatmentLine1 like '%/pem%') t1
on t0.sampleId1=t1.sampleId1
left join (
select sampleId1, pretreatmentLine2, pretreatmentLine2PdDate, pretreatmentLine2StopReason from nsclcPairedSample where preTreatmentLine2 like '%peme%' or preTreatmentLine2 like '%/pem%') t2
on t0.sampleId1=t2.sampleId1
left join (
select sampleId1, pretreatmentLine3, pretreatmentLine3PdDate, pretreatmentLine3StopReason from nsclcPairedSample where preTreatmentLine3 like '%peme%' or preTreatmentLine3 like '%/pem%') t3
on t0.sampleId1=t3.sampleId1
left join (
select sampleId1, pretreatmentLine4, pretreatmentLine4PdDate, pretreatmentLine4StopReason from nsclcPairedSample where preTreatmentLine4 like '%peme%' or preTreatmentLine4 like '%/pem%') t4
on t0.sampleId1=t4.sampleId1
left join (
select sampleId1, pretreatmentLine5, pretreatmentLine5PdDate, pretreatmentLine5StopReason from nsclcPairedSample where preTreatmentLine5 like '%peme%' or preTreatmentLine5 like '%/pem%') t5
on t0.sampleId1=t5.sampleId1
left join (
select sampleId1, pretreatmentLine6, pretreatmentLine6PdDate, pretreatmentLine6StopReason from nsclcPairedSample where preTreatmentLine6 like '%peme%' or preTreatmentLine6 like '%/pem%') t6
on t0.sampleId1=t6.sampleId1
left join (
select sampleId1, pretreatmentLine7, pretreatmentLine7PdDate, pretreatmentLine7StopReason from nsclcPairedSample where preTreatmentLine7 like '%peme%' or preTreatmentLine7 like '%/pem%') t7
on t0.sampleId1=t7.sampleId1
left join (
select sampleId1, pretreatmentLine8, pretreatmentLine8PdDate, pretreatmentLine8StopReason from nsclcPairedSample where preTreatmentLine8 like '%peme%' or preTreatmentLine8 like '%/pem%') t8
on t0.sampleId1=t8.sampleId1
left join 
(select sampleId1, posttreatmentbiopsy1Line1, posttreatmentbiopsy1Line1startDate, posttreatmentbiopsy1Line1PdDate, posttreatmentbiopsy1Line1StopReason from nsclcPairedSample where posttreatmentbiopsy1Line1 like '%peme%' or posttreatmentbiopsy1Line1 like '%/pem%') p1
on t0.sampleId1=p1.sampleId1
left join (
select sampleId1, posttreatmentbiopsy1Line2, posttreatmentbiopsy1Line2startDate, posttreatmentbiopsy1Line2PdDate, posttreatmentbiopsy1Line2StopReason from nsclcPairedSample where posttreatmentbiopsy1Line2 like '%peme%' or posttreatmentbiopsy1Line2 like '%/pem%') p2
on t0.sampleId1=p2.sampleId1
left join (
select sampleId1, posttreatmentbiopsy1Line3, posttreatmentbiopsy1Line3startDate, posttreatmentbiopsy1Line3PdDate, posttreatmentbiopsy1Line3StopReason from nsclcPairedSample where posttreatmentbiopsy1Line3 like '%peme%' or posttreatmentbiopsy1Line3 like '%/pem%') p3
on t0.sampleId1=p3.sampleId1
left join (
select sampleId1, posttreatmentbiopsy1Line4, posttreatmentbiopsy1Line4startDate, posttreatmentbiopsy1Line4PdDate, posttreatmentbiopsy1Line4StopReason from nsclcPairedSample where posttreatmentbiopsy1Line4 like '%peme%' or posttreatmentbiopsy1Line4 like '%/pem%') p4
on t0.sampleId1=p4.sampleId1
left join (
select sampleId1, posttreatmentbiopsy1Line5, posttreatmentbiopsy1Line5startDate, posttreatmentbiopsy1Line5PdDate, posttreatmentbiopsy1Line5StopReason from nsclcPairedSample where posttreatmentbiopsy1Line5 like '%peme%' or posttreatmentbiopsy1Line5 like '%/pem%') p5
on t0.sampleId1=p5.sampleId1
left join 
(select sampleId1, posttreatmentbiopsy2Line1, posttreatmentbiopsy2Line1startDate, posttreatmentbiopsy2Line1PdDate, posttreatmentbiopsy2Line1StopReason from nsclcPairedSample where posttreatmentbiopsy2Line1 like '%peme%' or posttreatmentbiopsy2Line1 like '%/pem%') pp1
on t0.sampleId1=pp1.sampleId1
left join (
select sampleId1, posttreatmentbiopsy2Line2, posttreatmentbiopsy2Line2startDate, posttreatmentbiopsy2Line2PdDate, posttreatmentbiopsy2Line2StopReason from nsclcPairedSample where posttreatmentbiopsy2Line2 like '%peme%' or posttreatmentbiopsy2Line2 like '%/pem%') pp2
on t0.sampleId1=pp2.sampleId1
left join (
select sampleId1, posttreatmentbiopsy2Line3, posttreatmentbiopsy2Line3startDate, posttreatmentbiopsy2Line3PdDate, posttreatmentbiopsy2Line3StopReason from nsclcPairedSample where posttreatmentbiopsy2Line3 like '%peme%' or posttreatmentbiopsy2Line3 like '%/pem%') pp3
on t0.sampleId1=pp3.sampleId1
left join (
select sampleId1, posttreatmentbiopsy2Line4, posttreatmentbiopsy2Line4startDate, posttreatmentbiopsy2Line4PdDate, posttreatmentbiopsy2Line4StopReason from nsclcPairedSample where posttreatmentbiopsy2Line4 like '%peme%' or posttreatmentbiopsy2Line4 like '%/pem%') pp4
on t0.sampleId1=pp4.sampleId1
left join (
select sampleId1, posttreatmentbiopsy2Line5, posttreatmentbiopsy2Line5startDate, posttreatmentbiopsy2Line5PdDate, posttreatmentbiopsy2Line5StopReason from nsclcPairedSample where posttreatmentbiopsy2Line5 like '%peme%' or posttreatmentbiopsy2Line5 like '%/pem%') pp5
on t0.sampleId1=pp5.sampleId1
left join (
select sampleId1, posttreatmentbiopsy2Line6, posttreatmentbiopsy2Line6startDate, posttreatmentbiopsy2Line6PdDate, posttreatmentbiopsy2Line6StopReason from nsclcPairedSample where posttreatmentbiopsy2Line6 like '%peme%' or posttreatmentbiopsy2Line6 like '%/pem%') pp6
on t0.sampleId1=pp6.sampleId1
left join (
select sampleId1, posttreatmentbiopsy2Line7, posttreatmentbiopsy2Line7startDate, posttreatmentbiopsy2Line7PdDate, posttreatmentbiopsy2Line7StopReason from nsclcPairedSample where posttreatmentbiopsy2Line7 like '%peme%' or posttreatmentbiopsy2Line7 like '%/pem%') pp7
on t0.sampleId1=pp7.sampleId1
left join (
select sampleId1, posttreatmentbiopsy2Line8, posttreatmentbiopsy2Line8startDate, posttreatmentbiopsy2Line8PdDate, posttreatmentbiopsy2Line8StopReason from nsclcPairedSample where posttreatmentbiopsy2Line8 like '%peme%' or posttreatmentbiopsy2Line8 like '%/pem%') pp8
on t0.sampleId1=pp8.sampleId1
WHERE 
(posttreatmentbiopsy1Line1 like '%peme%' or posttreatmentbiopsy1Line2 like '%peme%' or posttreatmentbiopsy1Line3 like '%peme%' or posttreatmentbiopsy1Line4 like '%peme%' or posttreatmentbiopsy1Line5 like '%peme%' or
posttreatmentbiopsy1Line1 like '%/pem%' or posttreatmentbiopsy1Line2 like '%/pem%' or posttreatmentbiopsy1Line3 like '%/pem%' or posttreatmentbiopsy1Line4 like '%/pem%' or posttreatmentbiopsy1Line5 like '%/pem%'
or posttreatmentbiopsy2Line1 like '%peme%' or posttreatmentbiopsy2Line2 like '%peme%' or posttreatmentbiopsy2Line3 like '%peme%' or posttreatmentbiopsy2Line4 like '%peme%' or posttreatmentbiopsy2Line5 like '%peme%' or posttreatmentbiopsy2Line6 like '%peme%' or posttreatmentbiopsy2Line7 like '%peme%' or posttreatmentbiopsy2Line8 like '%peme%'
