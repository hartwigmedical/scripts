...
left join 
(select sampleId, pretreatmentLine1, pretreatmentLine1PdDate, pretreatmentLine1StopReason from nsclcSingleSample where preTreatmentLine1 like '%Pacli%') t1
on t0.sampleId=t1.sampleId
left join (
select sampleId, pretreatmentLine2, pretreatmentLine2PdDate, pretreatmentLine2StopReason from nsclcSingleSample where preTreatmentLine2 like '%Pacli%') t2
on t0.sampleId=t2.sampleId
left join (
select sampleId, pretreatmentLine3, pretreatmentLine3PdDate, pretreatmentLine3StopReason from nsclcSingleSample where preTreatmentLine3 like '%Pacli%') t3
on t0.sampleId=t3.sampleId
left join (
select sampleId, pretreatmentLine4, pretreatmentLine4PdDate, pretreatmentLine4StopReason from nsclcSingleSample where preTreatmentLine4 like '%Pacli%') t4
on t0.sampleId=t4.sampleId
left join (
select sampleId, pretreatmentLine5, pretreatmentLine5PdDate, pretreatmentLine5StopReason from nsclcSingleSample where preTreatmentLine5 like '%Pacli%') t5
on t0.sampleId=t5.sampleId
left join (
select sampleId, pretreatmentLine6, pretreatmentLine6PdDate, pretreatmentLine6StopReason from nsclcSingleSample where preTreatmentLine6 like '%Pacli%') t6
on t0.sampleId=t6.sampleId
left join (
select sampleId, pretreatmentLine7, pretreatmentLine7PdDate, pretreatmentLine7StopReason from nsclcSingleSample where preTreatmentLine7 like '%Pacli%') t7
on t0.sampleId=t7.sampleId
left join (
select sampleId, pretreatmentLine8, pretreatmentLine8PdDate, pretreatmentLine8StopReason from nsclcSingleSample where preTreatmentLine8 like '%Pacli%') t8
on t0.sampleId=t8.sampleId
left join 
(select sampleId, posttreatmentLine1, posttreatmentLine1startDate, posttreatmentLine1PdDate, posttreatmentLine1StopReason from nsclcSingleSample where posttreatmentLine1 like '%Pacli%') p1
on t0.sampleId=p1.sampleId
left join (
select sampleId, posttreatmentLine2, posttreatmentLine2startDate, posttreatmentLine2PdDate, posttreatmentLine2StopReason from nsclcSingleSample where posttreatmentLine2 like '%Pacli%') p2
on t0.sampleId=p2.sampleId
left join (
select sampleId, posttreatmentLine3, posttreatmentLine3startDate, posttreatmentLine3PdDate, posttreatmentLine3StopReason from nsclcSingleSample where posttreatmentLine3 like '%Pacli%') p3
on t0.sampleId=p3.sampleId
left join (
select sampleId, posttreatmentLine4, posttreatmentLine4startDate, posttreatmentLine4PdDate, posttreatmentLine4StopReason from nsclcSingleSample where posttreatmentLine4 like '%Pacli%') p4
on t0.sampleId=p4.sampleId
left join (
select sampleId, posttreatmentLine5, posttreatmentLine5startDate, posttreatmentLine5PdDate, posttreatmentLine5StopReason from nsclcSingleSample where posttreatmentLine5 like '%Pacli%') p5
on t0.sampleId=p5.sampleId
left join (
select sampleId, posttreatmentLine6, posttreatmentLine6startDate, posttreatmentLine6PdDate, posttreatmentLine6StopReason from nsclcSingleSample where posttreatmentLine6 like '%Pacli%') p6
on t0.sampleId=p6.sampleId
left join (
select sampleId, posttreatmentLine7, posttreatmentLine7startDate, posttreatmentLine7PdDate, posttreatmentLine7StopReason from nsclcSingleSample where posttreatmentLine7 like '%Pacli%') p7
on t0.sampleId=p7.sampleId
left join (
select sampleId, posttreatmentLine8, posttreatmentLine8startDate, posttreatmentLine8PdDate, posttreatmentLine8StopReason from nsclcSingleSample where posttreatmentLine8 like '%Pacli%') p8
on t0.sampleId=p8.sampleId
left join (
select sampleId, posttreatmentLine9, posttreatmentLine9startDate, posttreatmentLine9PdDate, posttreatmentLine9StopReason from nsclcSingleSample where posttreatmentLine9 like '%Pacli%') p9
on t0.sampleId=p9.sampleId
WHERE 
(posttreatmentLine1 like '%Pacli%' or posttreatmentLine2 like '%Pacli%' or posttreatmentLine3 like '%Pacli%' or posttreatmentLine4 like '%Pacli%' or posttreatmentLine5 like '%Pacli%' or posttreatmentLine6 like '%Pacli%' or posttreatmentLine7 like '%Pacli%' or posttreatmentLine8 like '%Pacli%' or posttreatmentLine9 like '%Pacli%')
