...
select * from clinicalFindings where ecrfItem = "FRM.BIOPS" and message ="could not match any clinical biopsy with sequenced sample." and formLocked = 'false'; # lijstje Immy
...
inner join clinical on clinical.sampleId = sample.sampleId
inner join ecrf on ecrf.patientId = clinical.patientId
where clinical.patientId in ('CPCT02050172','CPCT02140012','CPCT02080157','CPCT02080136') and ecrf.item = "FLD.TRTAFTER.SYSREGPOST" and ecrf.itemValue =''
 and locked = 'false';
