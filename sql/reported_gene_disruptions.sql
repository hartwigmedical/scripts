SELECT structuralVariant.id, sampleId, gene, isStartEnd, exonRankUpstream, exonRankDownstream, exonMax, startOrientation, endOrientation, type, ploidy FROM structuralVariantDisruption
