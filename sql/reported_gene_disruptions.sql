SELECT structuralVariant.id, structuralVariant.sampleId, gene, strand, isStartEnd, exonRankUpstream, exonRankDownstream, exonMax, startOrientation, endOrientation, type, ploidy FROM structuralVariantDisruption
