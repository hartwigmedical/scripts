...
left join
    ...
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM86' group by patientId) TSTAM81
on ADTUM.patientId = TSTAM81.patientId
left join
    (select patientId, group_concat(itemValue separator ', ') as tstam82
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM86' group by patientId) TSTAM82
on ADTUM.patientId = TSTAM82.patientId
left join
    (select patientId, group_concat(itemValue separator ', ') as tstam83
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM86' group by patientId) TSTAM83
on ADTUM.patientId = TSTAM83.patientId
left join
    (select patientId, group_concat(itemValue separator ', ') as tstam84
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM86' group by patientId) TSTAM84
on ADTUM.patientId = TSTAM84.patientId
left join
    (select patientId, group_concat(itemValue separator ', ') as tstam85
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM86' group by patientId) TSTAM85
...
left join
    ...
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM86' group by patientId) TSTAM87
on ADTUM.patientId = TSTAM87.patientId
left join
    (select patientId, group_concat(itemValue separator ', ') as tstam88
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM86' group by patientId) TSTAM88
on ADTUM.patientId = TSTAM88.patientId
left join
    (select patientId, group_concat(itemValue separator ', ') as tstam89
    from ecrf where fieldName ='BASELINE.INFORMEDCONSENT.INFORMEDCONSENT.TSTAM87' group by patientId) TSTAM89
