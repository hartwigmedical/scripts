...
SELECT
    ...
    therapyEvidence.therapyId, therapy.ckbTherapyId, therapy.createDate as therapyCreateDate, therapy.updateDate as therapyUpdateDate,
    therapy.therapyName AS treatment, description,
    ...
    group_concat(treatmentApproachTherapy.therapyName) as therapyNames,
...
LEFT JOIN treatmentApproachTherapy ON treatmentApproachTherapy.treatmentApproachId=treatmentApproachEvidence.treatmentApproachEvidenceId
