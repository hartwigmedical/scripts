...
class StatusChecker:
    ...
    def _get_lama_data_used_for_report(self, report_record):
        ...
        candidate_paths = [
            f"gs://{self.oncoact_bucket.name}/corr-{sample_barcode}/patient-reporter.json",
            f"gs://{self.oncoact_bucket.name}/{sample_barcode}/patient-reporter.json",
            f"gs://{self.oncoact_bucket.name}/panel-{sample_barcode}/patient-reporter.json"
        ]
