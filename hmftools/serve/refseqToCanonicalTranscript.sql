use homo_sapiens_core_97_38
select gene.stable_id as geneId, transcript.stable_id as transcriptId, xref.display_label, xref.dbprimary_acc, transcript.seq_region_start, transcript.seq_region_end
from xref
