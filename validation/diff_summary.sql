...
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "germlineVariantPathogenic" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "germlineVariantReported" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "somaticVariant" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "somaticVariantReported" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "structuralVariant" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "svBreakendDisruptive" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "svBreakendReported" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "svFusion" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "svFusionReported" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "driverCatalog" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "virusBreakend" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "protectReported" AS Type,
  (SELECT COUNT(*) FROM VARIABLE_TRUTH_DB_SCHEMA.protect WHERE sampleId = "VARIABLE_TRUTH_SAMPLE_ID" AND reported = 1) AS Truth,
  (SELECT COUNT(*) FROM VARIABLE_NEW_DB_SCHEMA.protect WHERE sampleId = "VARIABLE_NEW_SAMPLE_ID" AND reported = 1) AS New,
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "hrStatus" AS Type,
...
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "msStatus" AS Type,
  ...
  (SELECT STRCMP(New, Truth)) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "tmbStatus" AS Type,
  ...
  (SELECT STRCMP(New, Truth)) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "tmlStatus" AS Type,
...
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "sufficientCoverage" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "purity" AS Type,
  ...
  (SELECT New - Truth) AS Delta
UNION
SELECT "VARIABLE_NEW_SAMPLE_ID" AS Sample, "ploidy" AS Type,
