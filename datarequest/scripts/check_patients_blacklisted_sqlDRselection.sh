...
#put SQL selectie query file path at $1 (for all use: all_patients_eligible_datarequests.sql, otherwise: DRXXX.sql)

execute_sql_on_prod /data/common/repos/scripts/datarequest/selection/$1 | sort | uniq > temp_datarequest.tsv
