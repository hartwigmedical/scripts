...
purityData <- purity %>%
  inner_join(sample) %>%
  dplyr::filter(arrivalDate >= '2020-01-01') %>%
  mutate(reportedDate >= reportedDateText)
metricData <- metric %>%
  inner_join(sample) %>%
  dplyr::filter(arrivalDate >= '2020-01-01') %>%
  mutate(reportedDate >= reportedDateText)
flagstatData <- flagstat %>%
  inner_join(sample) %>%
  dplyr::filter(arrivalDate >= '2020-01-01') %>%
  mutate(reportedDate >= reportedDateText)
...
score <- ggplot(purityData, aes(x = "x", y = score)) +
...
contamination <- ggplot(purityData, aes(x = "x", y = contamination)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = purityData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
unsupported <- ggplot(purityData, aes(x = "x", y = unsupportedCopyNumberSegments)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = purityData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
refTotal <- ggplot(metricData, aes(x = "", y = refPctExcTotal)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
...
refOverlap <- ggplot(metricData, aes(x = "", y = refPctExcOverlap)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
refCapped <- ggplot(metricData, aes(x = "", y = refPctExcCapped)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
refBaseQ <- ggplot(metricData, aes(x = "", y = refPctExcBaseQ)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
refUnpaired <- ggplot(metricData, aes(x = "", y = refPctExcUnpaired)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
refDupe <- ggplot(metricData, aes(x = "", y = refPctExcDupe)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
refMapQ <- ggplot(metricData, aes(x = "", y = refPctExcMapQ)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
tumorTotal <- ggplot(metricData, aes(x = "", y = tumorPctExcTotal)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
tumorOverlap <- ggplot(metricData, aes(x = "", y = tumorPctExcOverlap)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
tumorCapped <- ggplot(metricData, aes(x = "", y = tumorPctExcCapped)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
tumorBaseQ <- ggplot(metricData, aes(x = "", y = tumorPctExcBaseQ)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
tumorUnpaired <- ggplot(metricData, aes(x = "", y = tumorPctExcUnpaired)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
tumorDupe <- ggplot(metricData, aes(x = "", y = tumorPctExcDupe)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
tumorMapQ <- ggplot(metricData, aes(x = "", y = tumorPctExcMapQ)) +
  geom_boxplot(col = "black") +
  scale_y_sqrt() +
  geom_jitter(size = 0.45, alpha = 0.3, col = "royalblue3") +
  geom_point(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), color = "RED", size = 1.5, alpha = 0.9) +
...
refMean <- ggplot(metricData, aes(x = refMeanCoverage, color = reportedDate >= reportedDateText)) +
...
refSd <- ggplot(metricData, aes(x = refSdCoverage, color = reportedDate >= reportedDateText)) +
  geom_histogram(binwidth = 0.1) +
  geom_text(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), aes(y = 2, label = sampleId), hjust = -0.001, angle = 45, size = 2.5, position = position_jitter()) +
  theme(legend.position = "none")
ref30x <- ggplot(metricData, aes(x = refCoverage30xPercentage, color = reportedDate >= reportedDateText)) +
  geom_histogram(binwidth = 0.005) +
  geom_text(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), aes(y = 2, label = sampleId), hjust = -0.001, angle = 45, size = 2.5, position = position_jitter())

tumorMean <- ggplot(metricData, aes(x = tumorMeanCoverage, color = reportedDate >= reportedDateText)) +
  geom_histogram(binwidth = 1) +
  geom_text(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), aes(y = 2, label = sampleId), hjust = -0.001, angle = 45, size = 2.5, position = position_jitter()) +
  theme(legend.position = "none")
tumorSd <- ggplot(metricData, aes(x = tumorSdCoverage, color = reportedDate >= reportedDateText)) +
  geom_histogram(binwidth = 0.2) +
  geom_text(data = metricData %>% dplyr::filter(reportedDate >= reportedDateText), aes(y = 2, label = sampleId), hjust = -0.001, angle = 45, size = 2.5, position = position_jitter()) +
  theme(legend.position = "none")
tumor60x <- ggplot(metricData, aes(x = tumorCoverage60xPercentage, color = reportedDate >= reportedDateText)) +
...
outputFile <- paste0(outputDir, Sys.Date(), "_lab_report.pdf")
